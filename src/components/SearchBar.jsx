...
const SearchBar = () => {
  return (
    <div className="bg-neutral-100 w-[400px] h-[40px] rounded-3xl pl-6  pr-3 flex items-center justify-between	">
      <MagnifyingGlass size={18} />
      <input
        type="text"
        className="bg-neutral-100 text-neutral-300 text-xxs pl-2 w-3/4 "
